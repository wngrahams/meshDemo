...
int main () {
    ...
    GLfloat vertices[] = {
        -0.5f, -0.5f, -0.5f,            //each group corresponds to a face
        0.5f, -0.5f, -0.5f,             //first three vals on each row are vertex positions
        0.5f,  0.5f, -0.5f,             //last two are normalized texture coordinates
        0.5f,  0.5f, -0.5f,  
        -0.5f,  0.5f, -0.5f, 
        -0.5f, -0.5f, -0.5f, 
